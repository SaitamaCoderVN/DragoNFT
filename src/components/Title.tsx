...
const Title = ({className, startPoint}: TitleProps) => {
  ...
  return (
    <svg 
      ...
      <rect x="3601.5" y="16.5" width="197" height="215" rx="11.5" stroke="#CE8EEB" stroke-width="7" id='logoContainer'/>
