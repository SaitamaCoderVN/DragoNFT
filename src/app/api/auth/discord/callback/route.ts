...
const DISCORD_REDIRECT_URI = 'http://localhost:3000/api/auth/discord/callback'; // Ensure this matches your redirect URI
...
export async function GET(req: Request) {
    ...
    try {
        ...
        return NextResponse.redirect(`http://localhost:3000/profile/add_id_discord?discordId=${discordId}`);
    } catch (error) {
